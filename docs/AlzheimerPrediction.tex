...
\titleformat{\title}[block]
  {\normalfont\bfseries\Huge}{\thetitle}{0pt}{}  % Title formatting
...
% -------------------- Title Page Setup --------------------
\newcommand{\dissertationtitle}{Uncertainty-Aware Deep Learning for Early Detection of Alzheimer’s Disease Using MRI Images Data}
